...
//  Bookworm
//
//  Created by Damien Chailloleau on 15/12/2023.
//
...
struct AddBookView: View {
    ...
    let genres = ["Fantasy", "Horror", "Kids", "Mystery", "Poetry", "Romance", "Thriller", "Science-Fiction", "Uncatalogued"]
    
    var body: some View {
        NavigationStack {
            Form {
                Section {
                    TextField("Title's Name", text: $title)
